...
for layer_value in range(2,layer_count):
    val_correlation = fine_tuning_transfer_learning_comparison(
    ...
    print(f"Validation correlation: {val_correlation}", flush=True)
...
train_r_squared_finetune_TL = train_correlation_finetune_TL**2
...
data = [
    ["Approach","Train_Correlation", "Validation_Correlation", "Test_Correlation", "Train_MSE", "Validation_MSE", "Test_MSE", "Train_R2", "Validation_R2", "Test_R2", "p-value"],
    ["Freeze", train_correlation_freeze_TL, val_correlation_freeze_TL, test_correlation_freeze_TL, train_mse_freeze_TL, val_mse_freeze_TL, test_mse_freeze_TL, train_r_squared_freeze_TL, val_r_squared_freeze_TL, test_r_squared_freeze_TL, p_value_threshold],
    ["Fine_Tune", train_correlation_finetune_TL, val_correlation_finetune_TL, test_correlation_finetune_TL, train_mse_finetune_TL, val_mse_finetune_TL, test_mse_finetune_TL, train_r_squared_finetune_TL, val_r_squared_finetune_TL, test_r_squared_finetune_TL, p_value_threshold]
]
