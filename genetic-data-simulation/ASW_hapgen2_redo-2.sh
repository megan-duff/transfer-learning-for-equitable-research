...
./hapgen2 -m /storage/math/projects/duffme_gensim/Recom_Rates/ASW/ASW-${chr}-final.txt \
        ...
        -o /scratch/duffme_gensim/Simulations/ASW/sim_${sim_num}/ASW_1000GP_hm3_Phase3_chr${chr}_20k \
        -Ne 17469 \
        -n 20000 0 \
...
if ! grep 'Simulating haplotypes ... done' /scratch/duffme_gensim/Simulations/ASW/sim_${sim_num}/ASW_1000GP_hm3_Phase3_chr${chr}_20k.summary
then
...
../../.././plink --data ASW_1000GP_hm3_Phase3_chr${chr}_20k.controls\
		...
		--out ASW_1000GP_hm3_Phase3_chr${chr}_20k.controls;
done
fi
