...
def main():
    ...
    TL_freeze_loss_plot_figure_file=os.path.join(args.output_dir, "MLP_TL_freeze_loss_vs_epochs_plot.png")
    TL_fine_tune_loss_plot_figure_file=os.path.join(args.output_dir, "MLP_TL_fine_tune_loss_vs_epochs_plot.png")
    ...
    save_trained_best_model_TL_freeze_file=os.path.join(args.output_dir, "best_MLP_TL_freeze_model.keras")
    save_trained_best_model_TL_fine_tune_file=os.path.join(args.output_dir, "best_MLP_TL_fine_tune_model.keras")
...
# Set the CSV file path
    csv_file = os.path.join(args.output_dir, "MLP_TL_results.csv")
